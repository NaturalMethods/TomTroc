...
<div class="home flex-col">
    ...
    <section class="joinus flex-row">
        <div class="joinustxt flex-col">
            ...
            <p class="pus">Donnez une nouvelle vie à vos livres en les échangeant avec d'autres amoureux de la lecture.
    ...
    <section class="howitworks flex-col">
        ...
        <div>
            <form action="index.php" method="get">
                <button type="submit" name="action" value="books" class="howitworksbutton borderGreenButton">Voir tous les livres</button>
            </form>
        </div>
